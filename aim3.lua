local PLAYER = game.Players.LocalPlayer
            ...
            local UIS = game:GetService("UserInputService")-- made by c..
            local WorldToViewportPoint = CurrentCam.WorldToViewportPoint
            local mouseLocation = UIS.GetMouseLocation
            
            game:GetService("StarterGui"):SetCore("SendNotification", {Title = "by dev's hub", Text = "Divertiti!"})
            ...
            local UIStroke = Instance.new("UIStroke")UIStroke.Color = Color3.fromRGB(100,0,100) UIStroke.Parent = FOVFFrame UIStroke.Thickness = 1 UIStroke.ApplyStrokeMode = "Border" game:GetService("StarterGui"):SetCore("SendNotification", {Title = "https://discord.gg/KJyeHwrYMV", Text = "The Discord For More!"})
            ...
            TextBox.PlaceholderText = "https://discord.gg/cMYNZ4T8"
            TextBox.Text = "https://discord.gg/cMYNZ4T8 - clicca 2 volte per entrare"
